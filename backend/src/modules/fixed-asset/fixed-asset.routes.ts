...
const body = Type.Object({ assetNo: Type.String({ minLength: 1 }), name: Type.String({ minLength: 1 }), category: Type.String({ minLength: 1 }), purchaseDate: Type.String({ format: "date" }), startUseDate: Type.String({ format: "date" }), originalValue: Type.String(), residualRate: Type.String(), depreciationMethod: Type.Literal("STRAIGHT_LINE"), usefulLifeMonths: Type.Integer({ minimum: 1 }), depreciationExpenseAccountId: Type.Optional(Type.Integer({ minimum: 1 })), department: Type.Optional(Type.String()), custodian: Type.Optional(Type.String()) });
